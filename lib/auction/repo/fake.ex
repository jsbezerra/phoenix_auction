defmodule Auction.Repo.Fake do
  @moduledoc """
    Replaces an actual database with a "in-memory" one that allows the creation of a simple public interface in
    order to play with data as if it were a real database.
  """
